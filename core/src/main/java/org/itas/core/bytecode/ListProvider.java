 ...
 */
class ListProvider extends ContainerProvider implements FieldProvider, TypeProvider {
	...
	public static final ListProvider PROVIDER = new ListProvider();
	...
	public String getResultSet(CtField field) throws Exception {
		ClassType definType = 
				(ClassType)SignatureAttribute.toFieldSignature(field.getGenericSignature());

...
abstract class AbstractTypeProvider implements TypeProvider {
	...
	protected AbstractTypeProvider(FieldProvider fieldProvider) {
		this.fieldProvider = fieldProvider;
	}
	
	@Override
	public synchronized void fieldProcessing(MethodProvider provider, CallBack<FieldProvider> called) throws Exception {
		fieldProvider.setMethodProvider(provider);
		called.called(fieldProvider);
	}

 ...
 */
abstract class AbStractContainerProvider extends Provider {

	public AbStractContainerProvider(Modify modify) {
		super(modify);
	}
	...
	protected String toObjectCode(CtClass genericType, String value) throws Exception {
		...
		throw new ItasException("[" + AbStractContainerProvider.class.getName() + "] unsuppoted type: " + genericType.getName());
	}
}

...
public interface DataContainers {
  ...
  default String[][] parseDoubleArray(String content) {
    return ContainerImpl.instance.parseDoubleArray(content);  
  }
  
  default Pair<String, String>[] parsePair(String content) {
    return ContainerImpl.instance.parsePair(content);  
  }
  
  default String toString(Object[] array) {
    return ContainerImpl.instance.toString(array);
  }
  ...
  default String toString(Collection<?> c) {
    return ContainerImpl.instance.toString(c);
  }
  ...
  static class ContainerImpl {
	...
	public String[] parseArray(String content) {
	...
	public String[][] parseDoubleArray(String content) {
	  if (Objects.isEmpty(content)) {
	    return new String[][]{ };
	  }
	...
	public Pair<String, String>[] parsePair(String content) {
	  if (Objects.isEmpty(content)) {
	    return new Pair[]{};
	  }

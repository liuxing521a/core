...
final class ResPoolImpl implements ResPool, Binding, Constructors {
  ...
  /** 所有对象集合*/
  private Map<String, Resource> allResources;
	
  /** 分类列表*/
  private Map<Class<?>, List<Resource>> childResources;
...
class XmlInfo {
  ...
  private final List<Resource> xmlBeans;
  private final List<Map<String, String>> attributes;
	
  private XmlInfo(XmlHandler handle, List<Resource> xmlBean, 

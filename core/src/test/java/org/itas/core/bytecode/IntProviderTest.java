...
public class IntProviderTest extends AbstreactFieldProvider {
	...
	public void typeTest() {
		...
		Assert.assertEquals(true, provider.isType(int.class));
		Assert.assertEquals(true, provider.isType(Integer.class));
